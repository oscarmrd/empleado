...
-- Tiempo de generaciÃ³n: 21-09-2021 a las 19:04:48
-- VersiÃ³n del servidor: 5.7.35-0ubuntu0.18.04.1
-- VersiÃ³n de PHP: 7.3.29-1+ubuntu18.04.1+deb.sury.org+1
...
(4, 'Amalia Bayona', 'abayona@example.co', 'F', 8, 0, 'Para contactar a Amalia Bayona, puede escribir al correo electrÃ³nico abayona@example.co');
